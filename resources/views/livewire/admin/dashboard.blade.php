                                ...
                                <div class="lux-gallery-category-layout">
                                    <form action="/admin/upload-gallery" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div
                                            ...
                                            <span
                                                style="padding:5px 10px;border-radius:999px;background:rgba(225,197,100,.08);border:1px solid rgba(225,197,100,.18);color:#E1C564;font-size:9px;font-weight:800;letter-spacing:.1em;white-space:nowrap;">{{ $categoryPhotos->count() }}
                                                FOTO</span>
                                        </div>
                                        ...
                                        <div class="lux-gallery-scroll-body">
                                                    ...
                                                    @foreach ($categoryPhotos as $foto)
                                                        <div style="position:relative;border-radius:12px;overflow:hidden;aspect-ratio:1;background:#111;"
                                                            ...
                                                            <div class="gal-overlay"
                                                                ...
                                                                <form
                                                                    action="/admin/delete-gallery/{{ $foto->id }}"
                                                                    method="POST">
                                                                    @csrf @method('DELETE')
                                                                    <button type="submit"
                                                                ...
                                                                <form
                                                                    action="{{ route('admin.update.gallery', $foto->id) }}"
                                            ...
                                            @else
                                                <div class="lux-gallery-empty">
                                                    Belum ada foto untuk kategori {{ $category['label'] }}.<br>Upload
                                                    foto
