            ...
            <div class="hero-panel">
                <div class="hero-meta">
                    ...
                    <span class="text-[10px] uppercase tracking-[0.35em] gold-text">Session date
                        <?php echo e(date('d M Y', strtotime($booking->tanggal_pemotretan))); ?></span>
                </div>

                <div class="hero-copy">
                    <h1
                        class="hero-title playfair text-4xl md:text-5xl font-black tracking-tight text-white leading-tight">
                        <?php echo e(ucfirst($booking->kategori)); ?> <span class="gold-text">•</span>
                        <?php echo e($booking->photographer_name ?? 'Team Assignment'); ?></h1>
                    <p class="hero-code">Booking code <span
                            class="gold-text font-semibold"><?php echo e($booking->booking_code); ?></span></p>
                </div>

                <div class="flex flex-col gap-5">
                    <div class="stepper-shell">
                        <div class="stepper-row">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['label' => 'Pending', 'step' => 1], ['label' => 'Verified', 'step' => 2], ['label' => 'Editing', 'step' => 3], ['label' => 'Done', 'step' => 4]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php $active = $currentStep >= $stepData['step']; ?>
                                <div class="step-card">
                                    <div class="step-dot flex h-14 w-14 items-center justify-center rounded-full text-lg font-black <?php echo e($active ? 'step-dot-active text-black' : 'bg-white/10 text-white/60'); ?>"
                                        style="background:<?php echo e($active ? 'linear-gradient(135deg, #e4cea0 0%, #c9aa74 55%, #a77f48 100%)' : 'rgba(255,255,255,0.08)'); ?>;">
                                        <?php echo e($stepData['step']); ?>

                                    </div>
                                    <div class="step-label <?php echo e($active ? 'gold-text' : 'text-white/40'); ?>">
                                        <?php echo e($stepData['label']); ?></div>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$loop->last): ?>
                                    <div class="progress-track">
                                        <div
                                            class="progress-fill <?php echo e($currentStep > $stepData['step'] ? 'w-full' : 'w-0'); ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="text-center pt-4">
                        <div class="stage-pill mx-auto">
                            ...
                            <p class="luxury-text-gradient text-3xl md:text-4xl font-black">
                                <?php echo e(strtoupper($currentStatusLabel)); ?></p>
                            <p class="text-sm text-white/60">Terakhir diperbarui:
                                <?php echo e($booking->updated_at->format('d M Y H:i')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-panel">
                <div class="info-grid">
                    <div class="glass-card">
                        ...
                        <p class="meta-value"><?php echo e($booking->nama_customer); ?></p>
                    </div>
                    <div class="glass-card">
                        <p class="meta-label">Kategori</p>
                        <p class="meta-value"><?php echo e($booking->kategori); ?></p>
                    </div>
                    <div class="glass-card">
                        <p class="meta-label">Tanggal sesi</p>
                        <p class="meta-value"><?php echo e(date('d M Y', strtotime($booking->tanggal_pemotretan))); ?></p>
                    </div>
                    <div class="glass-card">
                        <p class="meta-label">Status pembayaran</p>
                        <p class="meta-value"><?php echo e(strtoupper($displayPaymentStatus ?? 'PENDING')); ?></p>
                    </div>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($booking->link_results): ?>
                    <div class="result-card section-gap-lg p-6 text-center md:p-8">
                        ...
                        <a href="<?php echo e($booking->link_results); ?>" target="_blank" class="btn-luxury">Download dari Google
                            Drive</a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\laragon\www\ProjectSIM\resources\views/track-result.blade.php ENDPATH**/ ?>