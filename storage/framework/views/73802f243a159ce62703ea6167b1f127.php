...
<head>
    ...
    <title><?php echo e(ucfirst($category)); ?> | LUXELENS</title>
    ...
    <style>
        ...
        *::after {
        ...
        <?php echo $__env->make('partials.portfolio-shared-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </style>
</head>
...
<body>
    ...
    <section class="pf-hero portfolio-hero">
        ...
        <h1 class="pf-hero-title portfolio-title">The <em><?php echo e($categoryLabel); ?></em> Stories</h1>
        <p class="portfolio-subtitle">Koleksi <?php echo e(strtolower($categoryLabel)); ?> dengan ritme tampilan yang seragam,
    ...
    <section class="pf-video-section portfolio-shell">
        <div class="portfolio-section-head">
            ...
            <h2 class="portfolio-section-title">Signature <em><?php echo e($categoryLabel); ?></em> Reels</h2>
        ...
        <div class="pf-video-grid portfolio-video-grid">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $currentVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vi => $videoFile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                    $videoId = 'pf-vid-' . ($vi + 1);
                ...
                ?>
                <div class="pf-video-item portfolio-video-card" id="<?php echo e($videoId); ?>">
                    <video src="<?php echo e($videoSrc); ?>" preload="metadata" playsinline loop muted></video>
                    <div class="pf-vid-click" onclick="pfOpenVideoLb(<?php echo e($vi); ?>)"></div>
                    ...
                    <span class="portfolio-video-label"><?php echo e($categoryLabel); ?> Film <?php echo e($vi + 1); ?></span>
                </div>
    ...
    <section class="pf-gallery-section portfolio-shell">
        <div class="portfolio-section-head">
            ...
            <h2 class="portfolio-section-title">Curated <em><?php echo e($categoryLabel); ?></em> Frames</h2>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($photos->count()): ?>
            <div class="pf-masonry">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="pf-masonry-item" onclick="pfOpenLb(<?php echo e($loop->index); ?>)">
                        <img src="<?php echo e($foto->image_url); ?>" alt="<?php echo e(ucfirst($category)); ?> <?php echo e($loop->iteration); ?>"
                            loading="lazy">
        ...
        <?php else: ?>
            <p class="pf-empty">Belum ada foto untuk kategori <em><?php echo e($category); ?></em>.</p>
    ...
    <section class="pf-cta">
        ...
        <a href="/booking?category=<?php echo e($category); ?>" class="pf-btn-book">
            Book <?php echo e(strtoupper($category)); ?> Session
            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                stroke-width="1.5">
    ...
    <script>
        /* ── VIDEO LIGHTBOX ── */
        const pfVideoItems = <?php echo json_encode($portfolioVideoItems, 15, 512) ?>;
...
<?php /**PATH D:\laragon\www\ProjectSIM\resources\views/portfolio-detail.blade.php ENDPATH**/ ?>