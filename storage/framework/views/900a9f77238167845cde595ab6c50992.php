...
<body>
    ...
    <div class="panel-photo">
        <img src="<?php echo e(asset('images/foto1.jpeg')); ?>" alt="Cinematic Photography">
        ...
        <div class="panel-dots">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 9; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <span></span>
    ...
    <div class="panel-form">
        ...
        <div class="form-wrap">
            ...
            <form action="<?php echo e(url('/login')); ?>" method="POST" id="login-form" novalidate>
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\ProjectSIM\resources\views/user-login.blade.php ENDPATH**/ ?>